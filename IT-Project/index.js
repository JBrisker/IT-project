...
const courses = [
  ...
  {id:1, name:"CSNT 115 A+ Software Essentials", credits:6, prereq:["noreq"], coreq:["CSNT 116"]},
  {id:2,name:"CSNT 116 A+ Hardware", credits:6, prereq:["noreq"], coreq:["CSNT 115"]},
  {id:3, name:"CMST& 210 Interpersonal Communication", credits:5, prereq:["noreq"]},
  //Quarter 2
  ...
  {id:6, name:"CSD 110 Computer Programming Fundamentals with Python", credits:5, prereq:["noreq"]},
  //Quarter 3
  ...
  //Quarter 4
  {id:10, name:"CJ& 101 Introduction to Criminal Justice", credits:5, prereq:["noreq"]},
  {id:11, name:"ENGL& 101 English Composition I", credits:5, prereq:["noreq"]},
  {id:12, name:"CS 143 Computer Science II Java", credits:5, prereq:["CS& 141"]},
  //Quarter 5
  {id:13, name:"MATH& 141", credits:5, prereq:["noreq"]},
  ...
  //Quarter6
  {id:16, name:"MATH& 142", credits:5, prereq:["noreq"]},
  ...
  //Quarter 7
  {id:19, name:"CSNT 257 Cloud Computing", credits:6, prereq:["noreq"]},
    ...
    <tbody>
      ${courses.map(i => `
        <tr>
          ...
          <td>${i.name}</td>
          <td>${i.credits ?? ""}</td>
          <td>${i.prereq ? i.prereq.join(", ") : ""}</td>
          <td>${i.coreq ? i.coreq.join(", ") : ""}</td>
        </tr>
      `).join("")}
    </tbody>
  </table>
